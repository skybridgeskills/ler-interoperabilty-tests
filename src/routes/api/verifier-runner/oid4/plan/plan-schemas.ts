...
/**
 * Request body for `POST /api/verifier-runner/oid4/plan`. `cryptosuite`
 * selects the suite the present-time fixtures are signed with; the body is kept
 * open for future per-run options. The response is a {@link VerifierRunPlan}.
 */
